...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    expect(createMenu({teste: {}, teste2: {}}).fetchMenu()).toEqual({teste: {}, teste2: {}});
    ...
    // ```
    expect(createMenu({teste: {}, teste2: {}}).consumption).toEqual([]);
    ...
    // ```
    const objetoRetornado = createMenu({teste: {}, teste2: {}});
    ...
    // ```
    expect(objetoRetornado.consumption).toEqual(['coxinha', 'agua', 'sopa', 'sashimi', 'agua', 'coxinha']);
    ...
    // ```
    expect(objetoRetornado2.pay()).toBe(11.70);
